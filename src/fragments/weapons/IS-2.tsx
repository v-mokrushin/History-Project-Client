    ...
    <TextBlock>
      <TextBlock>
        ...
        <Paragraph>
          ...
          нового тяжёлого танка. Сначала его называли «Слон» (эмблема{" "}
          <ExternalLink link="https://ru.wikipedia.org/wiki/502-й_тяжёлый_танковый_батальон">
            502-го тяжёлого танкового батальона
          </ExternalLink>
          ), из-за рисунка зверя на броне, но вскоре узнали настоящие имя —
        ...
        <Paragraph>
          ...
          конструктор завода № 100{" "}
          <ExternalLink link="https://ru.wikipedia.org/wiki/Котин,_Жозеф_Яковлевич">
            Жозеф Яковлевич Котин
          </ExternalLink>{" "}
          изучал итоги самого крупного танкового сражения за период Второй
          мировой войны — Курской битвы, он обратил внимание, что наиболее
          результативно боролась с немецкими «Кошками» 122-мм пушка А-19.
          Предполагалось пушку использовать в качестве истребления тяжёлых
          танков врага, так и было сделано. Ствол такой пушки удалось
          смонтировать на люльке и лафете 122-мм гаубицы М-30 и орудие Д-2
          успешно прошло все полевые испытания. Поэтому удалось «воплотить в
          жизнь» установку ствола А-19 в тяжёлый танк с применением круглой
          люльки, противооткатных устройств, а также подъемного механизма от
          опытной танковой 122-мм гаубицы У-11. Для реализации этого требовалось
          введение в конструкцию орудия мощного дульного тормоза.
        </Paragraph>
        <Paragraph>
      ...
      <TextBlock>
        ...
        <Image URL={images.scheme} fullWidth title="Схема бронирования" />
        <Paragraph>
