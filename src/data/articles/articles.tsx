...
const articles_data: IArticle[] = [
  {
    ...
    minBackgroundURL: "/images/articles/khalkhin_gol.jpg",
  ...
  },
  {
    ...
    author: "Алексей Исаев, Артем Драбкин",
    origin: "История Великой Отечественной войны 1941-1945 гг. в одном томе",
    minBackgroundURL: "/images/articles/plan.jpg",
  ...
  },
  {
    ...
    author: "Алексей Исаев, Артем Драбкин",
    origin: "История Великой Отечественной войны 1941-1945 гг. в одном томе",
    minBackgroundURL: "/images/articles/army.jpg",
  ...
  },
  {
    ...
    minBackgroundURL: "images/articles/kiev.jpg",
